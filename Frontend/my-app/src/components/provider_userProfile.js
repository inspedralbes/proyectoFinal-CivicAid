...
const UserInfo = () => {
    ...
    return (
        <div className="h-screen overflow-auto flex justify-center items-center lg:bg-orange-300">
            {isLoggedIn ?
                        ...
                        <div className="p-4 text-center text-white">
                            ...
                            {loading ?
                                ...
                                <div>
                                    ...
                                    {activeTab === "tab1" && (
                                        <div className="mt-5 overflow-y-hidden flex items-center justify-center">
                                            <div>
                                                <div className="mt-5 container border-4 border-orange-500 bg-orange-300 rounded-lg md:w-[600px] w-full md:shadow-lg transform duration-200 easy-in-out">
                                                    ...
                                                    <div className="bg-orange-200">
                                                        ...
                                                        <div className='text-center text-black font-bold'>
                                                            <h3>ID de usuario: {userInfo.id}</h3>
                                                        </div>
                                                        <div className="inline text-center px-14">
                                                            <h2 className="text-gray-800 text-3xl font-bold">{userInfo.name} {userInfo.surname} {userInfo.secondSurname}</h2>
